          ...
          <div className="w-full md:w-1/2 font-light">
            ...
            <Reveal>
              <p className="text-gray-800 dark:text-gray-300">
                On the back-end side, I'm proficient in
                languages like JavaScript (Node.js), and frameworks like
                Express. I also have a good understanding of databases such as
                MongoDB. This knowledge allows me to implement effective
                database management solutions. One of my biggest strength is my
                exceptional level of patience. I am continuously learning and
                exploring new technologies to stay up to date with industry
                trends.
              </p>
            </Reveal>
          </div>
